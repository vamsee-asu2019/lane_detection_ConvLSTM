...
save_path = "./save/result/shuffle_fourty_percent_data/UNet-ConvLSTM/"
#pretrained_path='./pretrained/unetlstm.pth'
pretrained_path='/content/drive/MyDrive/ANC_gitcode/LaneDetectionCode/pretrained/fourty_percent_data/UNet/94.33411926269531.pth'
